...
public class amazon_app {
    ...
    public static void merchandlist(){
        m_List.add(new merchands( "aswin", "1234","Mobiles",101,"approved"));
        m_List.add(new merchands("raja", "2222","Tablets",102,"approved"));
        m_List.add(new merchands("suriya", "3333","Furniture",103,"approved"));
    }
    ...
    public static void userlist(){
        user_list.add(new users( "vidul", "1111",120000,90));
        user_list.add(new users( "dharun", "2222",90000,91));
        user_list.add(new users( "guru", "9999",50000,92));
        user_list.add(new users( "vyshnav", "5555",40000,93));
    }
}
